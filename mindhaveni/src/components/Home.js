    ...
    <>
      ...
      >
        <div className="container" style={{ display: "flex", flexDirection: "column", gap: 10, alignItems: "center" }}>
          ...
          <div>
            <a href="#privacy" style={{ color: "#497568", marginRight: 14, textDecoration: "underline" }}>Privacy Policy</a>
            <a href="#terms" style={{ color: "#497568", textDecoration: "underline" }}>Terms</a>
          </div>
        </div>
      </footer>
    </>
